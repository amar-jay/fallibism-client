...
<div id="drawer-navigation" className={cn("fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform bg-white dark:bg-gray-800", showDrawer ?  "-translate-x-full" : "")} tabIndex={0} >
      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <button type="button" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  ...
                  <Icons.down className="w-6 h-6" onClick={() => openedSub !== "ecommerce" ? setOpenedSub("ecommerce"): setOpenedSub("")}/>
            </button>
            <ul id="dropdown-example" className={cn("py-2 space-y-2", openedSub === "ecommerce" ? "": "hidden")}>
                  <li>
