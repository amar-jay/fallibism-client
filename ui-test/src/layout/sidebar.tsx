...
const SidebarMenuDemo = () => {
  return (
    <NavigationMenu.Root className={styles.SidebarMenuRoot}>
      <NavigationMenu.List className={styles.SidebarMenuList}>
        <NavigationMenu.Item>
          <NavigationMenu.Trigger className={styles.SidebarMenuTrigger}>
            Learn <CaretDownIcon className={styles.CaretDown} aria-hidden />
          </NavigationMenu.Trigger>
          <NavigationMenu.Content className={styles.SidebarMenuContent}>
...
const ListItem = React.forwardRef(
  (
    ...
    <li>
      <NavigationMenu.Link asChild>
        <a
          className={cn(styles.ListItemLink, className)}
          {...props}
          ref={forwardedRef}
        >
